            ...
            <div class="login-container">
                <div class="signin-content">
                    <div class="signin-image">
                        <figure><img src="images/esignin.png" alt="sing up image"></figure>

                    </div>

                    <div class="signin-form">
                        <h3 class="form-title" style="color:rgb(0,127,152)">Employee Sign In</h3>
                        <form method="POST" class="register-form" id="login-form" action="elogin.php">
                            ...
                            <div class="form-group form-button">
                                <input type="submit" name="signin" id="signin" class="form-submit" style="background-color:rgb(0,127,152)" value="Log in" />
                                <a href="" style="text-decoration: none;color:rgb(0,127,152)">&emsp; Forgot Password</a>
                            </div>
