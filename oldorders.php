...
$query = "SELECT * FROM orders WHERE o_deli_by='$username'";
        ...
        <div class="row">
            <div class="col-10 offset-1">
                <?php if (mysqli_num_rows($all_order_data) == 0) { ?>
                    <h4 class="text-left mb-5">Orders Not Found</h4>
                <?php } else { ?>
                    ...
                    <div class="media">
                        ...
                        <div class="media-body pl-3 pt-2 mt-md-2">
                            <p><strong>Order Id : </strong><?php echo $oid; ?><br>
                                ...
                                <strong>Mobile : </strong><?php echo $omobile; ?><br>
                                <strong>Delivery Date : </strong><?php echo $odelidate; ?>
                            </p>
